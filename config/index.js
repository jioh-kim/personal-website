module.exports = {
  ...
  socialMedia: [
    {
      name: "Linkedin",
      url: "https://www.linkedin.com/in/jioh-kim/",
    },
    // {
    //   name: "Medium",
  ...
  navLinks: {
    ...
    button: {
      useFileName: true,
      name: "resume",
      fileName: "Ji-Oh Kim Resume September.pdf", // the file has to be placed inside the static folder at the root level
